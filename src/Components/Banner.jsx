      ...
      <div>
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 mb-32 p-4 ml-12 text-left w-1/2">
            ...
            <p className="text-white font-normal text-xl opacity-70 mb-5">
              {latestWebinar
                ? latestWebinar.description
                : "XYZ XSY SAJH AJJHS AJJAS"}
            </p>
            <div className="flex flex-row gap-4">
              ...
              <button
                onClick={toggleModal}
                className="bg-[#3a3a3a] gap-1 flex items-center hover:bg-[#606060] ease-in-out transition duration-300 h-10 w-auto px-3 rounded-md text-white text-lg font-semibold"
              >
                <InfoIcon />
                More Info
              </button>
